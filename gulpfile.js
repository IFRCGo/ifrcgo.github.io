...
gulp.task('build', function(done) {
  runSequence(['get-data', 'compress:main'], [ 'inject-vendor', 'inject-own'], 'fixin', ['jekyll', 'sass'], 'copy:assets', done);
});

gulp.task('dev', function(done) {
  runSequence('clean','compress:main', [ 'inject-vendor', 'inject-own'], 'fixin', ['jekyll', 'sass'], 'copy:assets', done);
});
